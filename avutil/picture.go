...
func AvImageFillArrays(dstData **uint8, dstLinesize [4]int32, src []uint8,
...
func AvImageCopy(dstData **uint8, dstLinesize [4]int32, srcData **uint8, srcLinesize [4]int32, pixFmt PixelFormat, width, height int ) {
